...
// for shadow
const vec2 offset(0.006, 0.006); // set to zero for no shadow
...
void main(void) {
    ...
    float alpha_total = alpha + (1.0 - alpha) * alpha_outline;
    float color_total = mix(color, outline_color, alpha / alpha_total);
